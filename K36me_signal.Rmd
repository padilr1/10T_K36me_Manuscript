...
# Input-normalized signal {.tabset}

## K36me1
```{r,K36me1,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_K36me_Manuscript/images/K36me_signal/K36me1", pattern= "*.png", full.names=T)
...
imageList <- list.files("~/Documents/10T_K36me_Manuscript/images/K36me_signal/K36me3", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

# CPM-only signal {.tabset}
